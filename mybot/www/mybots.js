...
function processUserInput() {
	...
	frappe.call({
			method: 'mybot.www.mybots.get_chat_response',
			args: {
	...
	frappe.call({
		method: 'mybot.www.mybots.get_chat_history',  // Path to your Python function
		callback: function(response) {
...
clearButton.addEventListener('click', function() {
	...
	frappe.call({
		method: 'mybot.www.mybots.clear_history',  // Path to your Python function
		callback: function(response) {
			const listElement = document.getElementById('list');
			response.message.forEach(item => {
				const li = document.createElement('li');
